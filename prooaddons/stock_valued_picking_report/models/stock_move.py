...
class StockMove(models.Model):
    ...
    def _get_sale_price_subtotal(self):
        ...
        if self.procurement_id and self.procurement_id.sale_line_id:
            ...
            price = (self.sale_price_unit * (1 - (self.sale_discount or 0.0) / 100.0))
            subtotal = line.tax_id.compute_all(price, self.product_qty, line.product_id, line.order_id.partner_id)['total']
